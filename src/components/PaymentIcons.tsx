...
const VisaSvg = () => (
  <svg viewBox="0 0 750 471" className="h-8 w-auto" xmlns="http://www.w3.org/2000/svg">
...
const IdealSvg = () => (
  <svg viewBox="0 0 60 48" className="h-8 w-auto rounded" xmlns="http://www.w3.org/2000/svg">
...
const PaymentIcons = () => {
  return (
    <div className="flex items-center justify-center gap-3 mt-4">
      <img src={applePay} alt="Apple Pay" className="h-8 w-auto opacity-70" />
      <VisaSvg />
